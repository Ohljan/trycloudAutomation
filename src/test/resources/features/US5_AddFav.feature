#5. Story: As a user, I should be able to add file to favorites.
...
Feature: As a user, I should be able to access to Files module - Favorites button
    ...
    And user click the "Favorites" sub-module on the left side Then Verify the chosen file is listed on the table